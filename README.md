...
![简易RPC架构](assets/简易RPC架构.svg)

## 注册中心基本实现调用关系

![注册中心基本实现调用关系](assets/注册中心基本实现调用关系.svg)

## 项目最终框架-RPC架构(注册中心)

时间：2025年06月25日

基于自定义简易RPC框架实现，集成了Etcd/Zookeeper作为服务注册与发现中心，支持自定义通信协议、服务注册与发现、负载均衡策略、自动重试机制以及服务容错处理，具备良好的扩展性与容灾能力。

项目功能：简易RPC框架+全局配置+接口Mock+自定义序列化器与SPI机制+注册中心+自定义协议+负载均衡+重试机制+容错机制

![RPC架构-注册中心终版](assets/RPC架构-注册中心终版.svg)